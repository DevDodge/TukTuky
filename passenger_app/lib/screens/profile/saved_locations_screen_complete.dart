...
class SavedLocationsScreenComplete extends ConsumerStatefulWidget {
  const SavedLocationsScreenComplete({Key? key}) : super(key: key);

  @override
  ConsumerState<SavedLocationsScreenComplete> createState() =>
      _SavedLocationsScreenCompleteState();
}

class _SavedLocationsScreenCompleteState
    extends ConsumerState<SavedLocationsScreenComplete> {
  @override
  void initState() {
    super.initState();
